      ...
      <div class="user-dashboard">
        <div class="employee-info">
          ...
          <div class="info">
            ...
            <p class="email-work-hours">Company Name</p>
            <p class="email-work-hours">HR Manager</p>
          </div>
        </div>

        <div class="content">
          <div class="date centered-content margin-top-25">
            <div class="start-date">
              <label class="start-date-label" for="start">
                Start date:
              </label>
              <input
                class="margin-right-25"
                type="date"
                id="start"
                min="2021-01-01"
                max="2030-12-31"
          ...
          <div class="centered-content margin-top-25">
            <Dropdown />
          </div>
          <div class="costs">
            <div class="row centered-content">
              <div class="section section1  margin-right-75">
                <p class="title">Absenteeism Cost</p>
                <p class="cost">$ 1bil</p>
              </div>
              <div class="section section2">
                <p class="title">Separation Cost</p>
                <p class="cost">$ 1bil</p>
              </div>
            </div>
            <div class="row centered-content margin-bottom">
              <div class="section section3 margin-right-75">
                <p class="title">Replacement Cost</p>
                <p class="cost">$ 1bil</p>
              </div>
              <div class="section section4">
                <p class="title">Training Cost</p>
                <p class="cost">$ 1bil</p>
              </div>
            </div>
          </div>
